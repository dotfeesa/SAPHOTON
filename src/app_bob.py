...
def main(app_config=None, key_length=128):
    num_bits = key_length*3
    ...
    raw_key = [
        pair.outcome for pair in pairs_info if pair.same_basis and not pair.test_outcome
    ]
    logger.info(f"bob raw key: {raw_key}")
